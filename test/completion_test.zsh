...
INSPECT_FLAGS[pod]="--namespace --resources --yaml --yml-path --label --az"
INSPECT_FLAGS[deployment]="--namespace --resources --yaml --yml-path --label --az --spec"
INSPECT_FLAGS[daemonset]="--namespace --resources --yaml --yml-path --az"
INSPECT_FLAGS[statefulset]="--namespace --resources --yaml --yml-path --az"
