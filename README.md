...
kdiag inspect po  [flags] <pod_name>
kdiag inspect po  [flags] -l <label_selector>
```
...
kdiag inspect pod -n example-system --resources gateway-proxy-abc123
...
kdiag az po   [flags] -l <label_selector>
```

### Example

```sh
kdiag az pods -n example-system -l 'app=gateway-proxy'
```
